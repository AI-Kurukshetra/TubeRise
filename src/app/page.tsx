    ...
    <main className="min-h-screen bg-white flex flex-col overflow-hidden">
      ...
      <nav className="glass fixed top-0 inset-x-0 z-50 flex items-center justify-between px-4 sm:px-8 h-16 border-b border-white/60">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <Link
            href="/signup"
            className="text-sm bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 text-white px-5 py-2.5 rounded-lg hover:opacity-90 transition-all font-medium shadow-md shadow-emerald-500/25"
          >
            Get started
          </Link>
        </div>
      ...
      <section className="gradient-hero flex items-center justify-center px-4 sm:px-8 pt-32 pb-20 sm:pt-40 sm:pb-28 relative">
        ...
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-teal-400/15 rounded-full blur-3xl animate-glow-pulse delay-700" />
        <div className="absolute top-40 right-1/4 w-48 h-48 bg-cyan-400/10 rounded-full blur-3xl animate-glow-pulse delay-300" />
        ...
        <div className="text-center max-w-3xl relative z-10">
          <div className="animate-fade-in inline-flex items-center gap-2 bg-white/80 backdrop-blur text-sm font-medium px-4 py-2 rounded-full mb-8 border border-slate-200/60 shadow-sm">
            <span className="w-2 h-2 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 rounded-full shrink-0" />
            <span className="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent font-semibold">Creator-brand partnerships, reimagined</span>
          </div>
          <h1 className="animate-slide-up text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 leading-[1.1] tracking-tight mb-6">
            ...
            <span className="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent">YouTube influencer campaigns</span>
          </h1>
          ...
          <div className="animate-slide-up delay-300 flex flex-col sm:flex-row items-center justify-center gap-3 mb-10">
            <Link
              href="/signup"
              className="w-full sm:w-auto bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 text-white px-8 py-3.5 rounded-xl font-medium hover:opacity-90 transition-all text-center shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 hover:-translate-y-0.5"
            >
              Get started free
            </Link>
            <a
      ...
      <section id="features" className="px-4 sm:px-8 py-20 sm:py-28 bg-slate-50/80 relative">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent mb-3 uppercase tracking-widest">Features</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="animate-slide-up bg-white rounded-2xl border border-slate-100 p-8 card-glow group">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center mb-5 shadow-lg shadow-emerald-500/25 group-hover:shadow-emerald-500/40 transition-shadow">
            ...
            <div className="animate-slide-up delay-200 bg-white rounded-2xl border border-slate-100 p-8 card-glow group">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center mb-5 shadow-lg shadow-teal-500/25 group-hover:shadow-teal-500/40 transition-shadow">
                <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="animate-slide-up delay-400 bg-white rounded-2xl border border-slate-100 p-8 card-glow group">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-600 flex items-center justify-center mb-5 shadow-lg shadow-cyan-500/25 group-hover:shadow-cyan-500/40 transition-shadow">
                <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section id="how-it-works" className="px-4 sm:px-8 py-20 sm:py-28 relative">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent mb-3 uppercase tracking-widest">How It Works</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16">
            {/* For Brands */}
            <div className="bg-gradient-to-br from-teal-50/80 to-emerald-50/50 rounded-2xl p-8 border border-teal-100/60">
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-gradient-to-r from-teal-600 to-emerald-600 text-white mb-8 shadow-md shadow-teal-500/20 uppercase tracking-wide">
                For Brands
              </div>
              <div className="space-y-8">
                <div className="flex gap-4">
                  <div className="w-9 h-9 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg flex items-center justify-center shrink-0 text-white text-sm font-bold shadow-md shadow-emerald-500/20">1</div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="w-9 h-9 bg-gradient-to-br from-teal-500 to-teal-600 rounded-lg flex items-center justify-center shrink-0 text-white text-sm font-bold shadow-md shadow-teal-500/20">2</div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="w-9 h-9 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-lg flex items-center justify-center shrink-0 text-white text-sm font-bold shadow-md shadow-teal-500/20">3</div>
                  <div>
            ...
            {/* For Creators */}
            <div className="bg-gradient-to-br from-cyan-50/80 to-teal-50/50 rounded-2xl p-8 border border-cyan-100/60">
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-gradient-to-r from-cyan-500 to-teal-600 text-white mb-8 shadow-md shadow-cyan-500/20 uppercase tracking-wide">
                For Creators
              </div>
              <div className="space-y-8">
                <div className="flex gap-4">
                  <div className="w-9 h-9 bg-gradient-to-br from-cyan-500 to-teal-500 rounded-lg flex items-center justify-center shrink-0 text-white text-sm font-bold shadow-md shadow-cyan-500/20">1</div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="w-9 h-9 bg-gradient-to-br from-teal-500 to-emerald-500 rounded-lg flex items-center justify-center shrink-0 text-white text-sm font-bold shadow-md shadow-teal-500/20">2</div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="w-9 h-9 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg flex items-center justify-center shrink-0 text-white text-sm font-bold shadow-md shadow-emerald-500/20">3</div>
                  <div>
      ...
      {/* ── CTA Footer Banner ── */}
      <section className="px-4 sm:px-8 py-20 sm:py-28 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 relative overflow-hidden">
        {/* Decorative circles */}
